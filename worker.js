...
<body>
    ...
    <script>
        ...
        function updateYaoDisplay(yaoNum, value, type) {
            ...
            if (!row) {
                console.error('Could not find element for yaoRow' + yaoNum);
                return;
            }
        ...
        function showResult() {
            ...
            console.log('yaoResults:', yaoResults); // Debug log
            var hexagramBinary = '';
            for (var i = yaoResults.length - 1; i >= 0; i--) {
                hexagramBinary += yaoResults[i].type.isYang ? '1' : '0';
            }
            
            console.log('Hexagram Binary:', hexagramBinary); // Debug log
            ...
            if (!hexagram) {
                ...
                console.warn('Unknown hexagram binary:', hexagramBinary);
            }
            ...
            if (movingYaos.length === 0) {
                ...
                console.log('Bian Gua Binary:', bianBinary); // Debug log
                ...
                if (bianHexagram) {
                    ...
                    console.warn('Unknown Bian Gua binary:', bianBinary);
                }
                ...
                if (bianHexagram) {
                    ...
                    var staticYaoHtml = '';
                    for (var n = 0; n < 6; n++) {
                        if (!movingYaos.includes(n) && bianHexagram.yaoText && bianHexagram.yaoText[n]) {
